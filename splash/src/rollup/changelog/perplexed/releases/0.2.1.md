...
---
<!-- Rolled up from perplexed/changelog/releases/0.2.1.md. Edit at the source, not here. Re-run `pnpm rollup:sync` to refresh. -->
...
- **Prior release:** [`0.2.0`](https://github.com/lossless-group/perplexed-plugin/blob/main/changelog/releases/0.2.0.md) — Google Gemini joins the provider lineup
