---
site_uuid: f455d758-b5f3-4b44-9180-550328d2b019
hex_code: ocq1ye
title: "New Obsidian Plugin: Metafetch Plugin Release 0.1.2"
lede: Bringing professional-grade content management to Obsidian with Obsidian plugins, one at a time.  Introducing Metafetch.
date_authored_initial_draft: 2025-07-18
date_authored_current_draft: 2025-07-18
authors:
  - Michael Staton
...
tags:
  ...
  - API-Integrations
from: metafetch
from_path: 2025-07-18_01.md
---
<!-- Rolled up from metafetch/changelog/2025-07-18_01.md. Edit at the source, not here. Re-run `pnpm rollup:sync` to refresh. -->

# Metafetch Plugin Release "0.1.2"

## Overview
Metafetch is an Obsidian plugin that automatically fetches and embeds Open Graph metadata from URLs found in your notes. It enhances your note-taking workflow by automatically populating frontmatter with rich metadata, including titles, descriptions, and images from linked web pages.
...
In addition, we can give this Metafetch plugin to the Obsidian community, and hopefully attract more developers with similar interests and goals. 
...
2. **Modals**
   - `MetafetchModal.ts`: Single file processing
   - `BatchMetafetchModal.ts`: Batch processing interface
