---
site_uuid: 14f22cc1-92fa-4d8c-968f-886b18040164
hex_code: mya0v8
title: Metafetch 0.1.6 — every release asset cryptographically attested
lede: When you install a community plugin you trust that the bytes in your vault were built from the source you can read. Most plugins ask you to take that on faith. From 0.1.6, Metafetch ships GitHub artifact attestations you can verify before you enable it.
...
publish: true
from: metafetch
from_path: releases/0.1.6.md
---
<!-- Rolled up from metafetch/changelog/releases/0.1.6.md. Edit at the source, not here. Re-run `pnpm rollup:sync` to refresh. -->
