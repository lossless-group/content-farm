...
---
<!-- Rolled up from cite-wide/context-v/issues/Paste-LLM-Content-Drops-Structure-And-Emits-Link-Only-Citations.md. Edit at the source, not here. Re-run `pnpm rollup:sync` to refresh. -->
