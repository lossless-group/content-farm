...
publish: false
from: cite-wide
from_path: workflow/2026-05-01_Refactor.md
---
<!-- Rolled up from cite-wide/context-v/workflow/2026-05-01_Refactor.md. Edit at the source, not here. Re-run `pnpm rollup:sync` to refresh. -->
