---
from: perplexed
from_path: specs/Using-Files-as-Prompt-Outlines.md
---
<!-- Rolled up from perplexed/context-v/specs/Using-Files-as-Prompt-Outlines.md. Edit at the source, not here. Re-run `pnpm rollup:sync` to refresh. -->
