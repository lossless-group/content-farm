...
from: perplexed
from_path: issues/Widen-Modals-in-Obsidian-using-CSS.md
---
<!-- Rolled up from perplexed/context-v/issues/Widen-Modals-in-Obsidian-using-CSS.md. Edit at the source, not here. Re-run `pnpm rollup:sync` to refresh. -->
