...
---
<!-- Rolled up from file-transporter/context-v/reminders/This-is-an-Obsidian-plugin-Read-Obsidian-API-Docs.md. Edit at the source, not here. Re-run `pnpm rollup:sync` to refresh. -->
